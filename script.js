let reflexao = [
  ...
  "EXISTE UMA NATUREZA POÉTICA NO MINIMALISMO QUE É SOBRE O EQUILÍBRO ENTRE O CHEIO E O VAZIO. - JENNIE C. JONES",
  ...
  "OS ESSENCIALISTAS VEEM AS SOLUÇÕES DE CONCESSÃO COMO PARTE INERANTE DA VIDA, NÃO COMO ALGO NEGATIVO. EM VEZ DE INDAGAR: DO QUE TENHA QUE ABRIR MÃO?, PERGUNTAM: EM QUE QUERO INVESTIR TUDO?. O IMPACTO COMULATIVO DESSA PEQUENA MUDANÇA DE PONTO DE VISTA PODE SER PROFUNDO. - GREG MCKEOWN",
  ...
  "OS ESSENCIALISMO PASSAM O MAIOR TEMPO POSSÍVEL EXPLORANDO, EXCUTANDO, DABATENDO, QUESTIONANDO E PENSANDO. MAS ESSA EXPLORAÇÃO NÃO É UM FIM EM SI. SEU PROPÓSITO É DISCERNIR AS POUCAS VITAIS DAS MUITAS TRIVIAIS. - GREG MCKEOWN",
]
